        ...
        <div className={styles.blog_div}>
          ...
          <div className={styles.blog_content}>
            ...
            <figure className={styles.blog_fig}>
               <div>
                <iframe allowFullScreen = "true" src="https://www.youtube.com/embed/-ChLT7b2Gj8" frameborder="0" scrolling="no" >
                #document (https://www.youtube.com/embed/-ChLT7b2Gj8)
                </iframe>
               </div>
            </figure>
            <h5>10 tell-tale signs you need to get a new business
            </h5>
            <p>
            But because those who do not know how to pursue pleasure rationally encounter extremely painful
             consequences. Nor again is there anyone who loves or pursues or desires to obtain pain of itself,
            ...
            These cases are perfectly simple and easy to distinguish. In a free hour,
             when our power of choice is untrammeled and when nothing prevents our being able to do what we like best,
              every pleasure is to be welcomed and every pain avoided.
               But in certain circumstances and owing to the claims of duty or the obligations of business it wil
               l frequently occur that pleasures have to be repudiated and annoyances accepted.
