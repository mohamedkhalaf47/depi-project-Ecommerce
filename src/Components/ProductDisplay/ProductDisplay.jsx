    ...
    <div className="row g-4">
      ...
      <div className="col-lg-6 col-md-12 d-flex flex-column justify-content-start">
        ...
        <div className={styles.addToCartSection}>
          ...
          />
          <button className={`btn btn-sm btn-dark mt-3 ${styles.addToCartBtn}`}>
            Add to Cart
          </button>
        </div>
      ...
      <div>
        <img src="../../../src/assets/freeShipping_icon-01.svg" alt="freeShipping" />
        <h4>Free Shipping</h4>
        <p>Perceived end knowledge certainly day sweetness why cordially. Ask a quick six seven offer see among.</p>
      </div>
      <div>
        <img src="../../../src/assets/fastDelivery_icon-02.svg" alt="freeShipping" />
        <h4>Fast Delivery</h4>
        <p>Parlors waiting so against me no. Wishing calling is warrant settled was lucky.</p>
      </div>
      <div>
        <img src="../../../src/assets/quality_icon-03.svg" alt="freeShipping" />
        <h4>100% Quality Guarantee</h4>
        <p>Unaffected at ye of compliment alteration to. Place voice no arises along to.</p>
      </div>
    </div>
